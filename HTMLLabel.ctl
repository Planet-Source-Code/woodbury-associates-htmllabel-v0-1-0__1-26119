...
' Private constants.
'
Private Const mcstrVersion          As String = "0.1.0"
...
Public Property Let DocumentHTML(strNewVal As String)
    ...
    ' Reset the colour.
    BackColor = mcstrDefaultBackColor
        ...
        If maudtElement(intElem).blnIsTag Then
            ...
            Select Case maudtElement(intElem).hetType
                ...
                Case hetHeaderon
                    ...
                    lngIndentStep = picHTML.TextWidth("W") * 2
                    If blnLayoutChanged Then
                        If picHTML.CurrentY > clngPadding Then
                ...
                Case hetAoff
                    If mblnEnableAnchors Then
                        ...
                        If intLinkElement > -1 Then
                            If blnLayoutChanged Then
                                maudtElement(intLinkElement).lngBottom = lngY + lngLineHeight - clngPadding
                            End If
                    ...
                    End If
                Case hetIMG
                    If Len(maudtElement(intElem).strImgAlt) > 0 Then
                        picHTML.CurrentX = lngX
                        picHTML.CurrentY = lngY
            ...
            If maudtElement(intElem).blnCentre Then
                ...
                While intWord <= UBound(maudtElement(intElem).astrWords)
                    ...
                    If intWord <= UBound(maudtElement(intElem).astrWords) Then
                        Do While picHTML.TextWidth(strValue & " " & maudtElement(intElem).astrWords(intWord)) <= _
                    ...
                    picHTML.CurrentY = lngY
                    picHTML.CurrentX = (((lngMarginRight - lngMarginLeft - (clngPadding * 2)) - _
